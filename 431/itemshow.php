...
<article id="mainContent">
    ...
    <article id="gallery" class="post">
      <div id="painting1" class="painting" draggable="true">
			...
			$result = mysql_query("SELECT * FROM item WHERE i_id='$i_id'");
			$rs=mysql_fetch_array($result);
			echo "<img src=$rs[pict] width='190' height='190'></img>"; ?>
	  </div>
	  <div>
	    <p>Seller - 
		    <?php 
			$result = mysql_query("SELECT * FROM bide_posted WHERE item_posted_id='$i_id'");
			$rs=mysql_fetch_array($result);
			$u_id=$rs[bp_id];
	  ...
	  <div>
	  <form class="form-submit" name="submit" method="post" action='search result.php'>
...
<h2><a href="./logout.php">Logout</a></h2>
    ...
    <section class="info">
      <div class="widget">
	   <form class="form-wrapper" name="search" method="post" action='search result.php'>
