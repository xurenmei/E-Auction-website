...
fuction go() {
 window.location.href="serch test.php";
}
</script> 
...
while($rs = mysql_fetch_array( $result )) 
 ...
 //header("location: $page");
  $result2 = mysql_query("SELECT * FROM item where i_id=$rs[ci_id]"); 
  $rs2=mysql_fetch_array($result2);
 $deadline=$rs2[deadline];
 $item = $rs['ci_id']; 
 echo "<br>";
 echo "<br>";  
 echo "<a href='itemshow.php?item=$item'><img src=$rs2[pict] width='240' height='240'></img></a>";
 echo "<br>"; 
 echo $rs2['i_name'];
 echo "<br>";
 echo "Item id:";
 ...
 if (date("Y-m-d",time())>$deadline){
  echo "You win this auction!";
  echo "<br>";
  echo "<a href='payment.php?item=$item'><input type='button' value='Pay now' style=width:100px height:49px></a>";
  // echo "<input name='pay' type=button value='Pay now' style=width:100px height:49px onclick='window.location.href='search test.php';'>";
}
else 
{
  echo "End time:";
