...
<font face="Impact">
    ...
    <form action="order.php" method="POST"  target="_User" name="Web Form" enctype="multipart/form-data"
      ...
      <table border="1px" bordercolor="white" cellpadding="3px" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <td><input type="hidden" name="i_id" value=<?php echo "$i_id";?> /> 
...
if($card_no!=NULL)
{
$result2=mysql_query("insert into payment(pay_id,u_id,a_id,card_no,ex_date,cvc,name,street,city,statename,country,zipcode) values(NULL,'1','$a_id','$card_no','$ex_date','$cvc','$name','$street','$city','$statename','$country','$zipcode')");
...
//echo "<script>location.href='order.php?i_id=$i_id';</script>"; 
echo "<a href='order.php?i_id=".$i_id."'></a>";
//header("location:order.php?i_id=".$i_id);
}
else 
{
