...
<header class="blogHeader pageHeader">
  <h1>Auction Hub<a href="D:\Program Files\XAMPP\htdocs\renmei\hub-login.php" title="home"></a></h1>
...
<article id="mainContent">
    <h1>This is your searching result:</h1>
    <article class="post">
...
while($rs = mysql_fetch_array( $result )) 
 ...
 echo $rs['i_id'];
 echo "<br>";
 echo "<a href='itemshow.php?item=$item'><img src=$rs[pict] width='240' height='240'></img></a>";
 echo "<br>"; 
 echo "<br>"; 
 echo "<br>"; 
 echo "<br>"; 
