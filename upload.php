...
<?php
session_start();
echo "<font color='red' size=3 style='position:absolute;left:1110;top:110'>" .$_SESSION['username']."</font>";
      ...
      <table border="1px" bordercolor="white" cellpadding="3px" cellspacing="0">
        <tbody>
		 ...
		 <tr>
		  ...
		  <tr>
            <td>Buy It Now:</td>
            <td><input name="bin" required="required" type="text" id="bin"/></td>
          </tr>
		  <tr>
            <td>Amount:</td>
...
$result1=mysql_query("insert into item(i_id,i_name,color,deadline,description,location,pict,bide_price,buy_it_now,available) values(NULL,'$i_name','$color','$deadline','$description','$location','0','$price','$bin','0')");
